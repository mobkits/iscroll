// npm i gulp-serve gulp-livereload webpack webpack-dev-server gulp-util gulp connect-livereload -D
...
gulp.task('example', function (callback) {
  devCompiler.run(function (err, stats) {
    if (err) throw new gutil.pluginError('example', err) //eslint-disable-line
